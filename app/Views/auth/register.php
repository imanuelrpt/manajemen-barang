...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
  ...
  <div class="flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden w-full max-w-4xl">
    ...
    <div class="hidden md:flex items-center justify-center bg-blue-100 w-1/2 p-6">
      <img src="https://cdn-icons-png.flaticon.com/512/747/747376.png" alt="Register Icon" class="w-64 h-64">
    </div>

    <!-- Form Register -->
    <div class="w-full md:w-1/2 p-8">
      <h2 class="mb-6 text-3xl font-bold text-center text-gray-800">Register</h2>
      ...
      <p class="mt-6 text-center text-gray-600 text-sm">
        Sudah punya akun? 
        <a href="/login" class="text-blue-500 font-medium hover:underline">Login di sini</a>
      </p>
    </div>
  </div>
